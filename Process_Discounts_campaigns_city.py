    ...
    try:
        ...
        for index, Campaign_button in enumerate(Campaign_buttons):
            try:
                ...
                if match:
                    restaurant_id_text = match.group(1)  # Capture the number after "RID :"
                else:
                    print("Restaurant_Id not found.")

                # Split restaurant_id by commas into a list
                restaurant_ids = restaurant_id_text.split('|')
                ...
                for restaurant_id in restaurant_ids:
                    rest_id = restaurant_id.strip()  # Remove any leading/trailing spaces
                    data = {
